...
# Project name :: validate-enum-str
...
Group Id : oss.merusphere.mvnplugin
SCM URL : https://github.com/merusphere-OSS/validate-enum-str.git
Project URL : https://github.com/merusphere-OSS/validate-enum-str.git
```
...
```
To register this Group Id you must prove ownership of the domain merusphere.com adding a TXT record to your DNS with the text: OSSRH-<JIRAID>
...
1. Enter Phassphrase in this case it is 'merusphere-OSS'

```
pcv@HYDMAC025 validate-enum-str % gpg --full-gen-ke
...
Real name: merusphere-OSS
Email address: corporate@merusphere.com
Comment: merusphere-OSS
You selected this USER-ID:
    "merusphere-OSS (merusphere-OSS) <corporate@merusphere.com>"
...
uid                      merusphere-OSS (merusphere-OSS) <corporate@merusphere.com>
sub   rsa3072 2022-01-02 [E]

pcv@HYDMAC025 validate-enum-str % 
```
...
```
pcv@HYDMAC025 validate-enum-str % gpg --send-key 839C4A82B068E031570C5452559FE948461241F8
...
```
Verify corporate@merusphere.com for your key on keys.openpgp.org
```
...
<gpg.passphrase>merusphere-OSS</gpg.passphrase>
</properties>
</profile>
</profiles>
...
<servers>
  <server>
    <id>ossrh</id>
    <username>devops-merusphere</username>
...
```
<scm>
	<connection>scm:git:https://github.com/merusphere-OSS/validate-enum-str.git</connection>
	<url>https://github.com/merusphere-OSS/validate-enum-str</url>
	<developerConnection>scm:git:https://github.com/merusphere-OSS/validate-enum-str</developerConnection>
	<tag>HEAD</tag>
</scm>
```
...
```
Then check the Artifacts after 4 to 12 hrs at [Maven Cental](https://s01.oss.sonatype.org/content/repositories/snapshots/com/merusphere/oss/ci/validate-enum-str/)
...
```
mvn oss.merusphere.mvnplugin:validate-enum-str:1.4.7-SNAPSHOT:svc-layer-validate
```
